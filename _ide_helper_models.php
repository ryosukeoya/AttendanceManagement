 ...
 * @property \Illuminate\Support\Carbon $total_minutes
 ...
 * @method static \Illuminate\Database\Eloquent\Builder|AttendanceRecord whereEndTime($value)
 * @method static \Illuminate\Database\Eloquent\Builder|AttendanceRecord whereId($value)
 * @method static \Illuminate\Database\Eloquent\Builder|AttendanceRecord whereStartTime($value)
 * @method static \Illuminate\Database\Eloquent\Builder|AttendanceRecord whereTotalMinutes($value)
 ...
 * @property \Illuminate\Support\Carbon|null $created_at
 * @property \Illuminate\Support\Carbon|null $updated_at
 * @property-read \Illuminate\Database\Eloquent\Collection|\App\Models\AttendanceRecord[] $attendanceRecord
 * @property-read int|null $attendance_record_count
